...
```{r detByNaming, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=3, fig.height=3, fig.cap = "Proportion face detections around a naming instance ('Look, a Zem'; +/- 2 seconds around each utterance) as a function of infants' posture. Each point represents a naming instance for each child in the dataset."}
#boxplot
ggplot(aroundNamings, aes(x = factor(posture), y = face, color=posture)) + 
  geom_boxplot() + 
  ylab("Prop. faces detedcted") + 
  xlab("Posture") + 
  theme_bw() 
