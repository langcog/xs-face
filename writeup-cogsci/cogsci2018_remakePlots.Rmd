...
ggsave("Fig3-TimebyPos.png", width = 4, height = 4,unit =  "in", plot = fig1, path="./figs/", device = "png",dpi = 300)
```
...
ggsave("Fig4-DetbyAge.png", width = 3, height = 4,unit =  "in", plot = fig4, path="./figs/", device = "png",dpi = 300)
```
...
ggsave("Fig5-DetbyOrientation.png", width = 6, height = 3,unit =  "in", plot = fig5, path="./figs/", device = "png",dpi = 300)
...
fig7=ggarrange(p1,p2, p3, p4)

ggsave("Fig7-Naming.png", width = 3, height = 3,unit =  "in", plot = fig7, path="./figs/", device = "png",dpi = 300)
```
