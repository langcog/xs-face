...
ggsave("Fig3-TimebyPos.png", width = 5, height = 5,unit =  "in", plot = fig1, path="./figs/", device = "png",dpi = 300)
```
...
ggsave("Fig4-DetbyAge.png", width = 5, height = 4,unit =  "in", plot = fig4, path="./figs/", device = "png",dpi = 300)
```
