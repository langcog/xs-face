...
### Load demographics
```{r}
# All of the videos were filmed with an MD-80 headcam. Some videos had a fisheye lens attached to them that increased their FOV by approximately 50% in both directions (see manuscript; in demographics column "fisheye"). This was determined by looking at the third-person videos.
