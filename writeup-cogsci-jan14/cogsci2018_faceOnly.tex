...
environments. We find that infants' postural changes largely mediate
...
children's posture and orientation relative to their caregiver were also
...
Zhang, Zhang, Li, \& Qiao, 2016, Cao, Simon, Wei, \& Sheikh (2017)) to
...
an important goal of this study. We used a total of two face detection
systems to explore infants' changing access to social information and to
avoid the cost of hand-annotating every frame. We capitalized on recent
improvements in computer vision algorithms, testing the performance of
two state-of-the-art face detectors that used novel methods to extract
face information.
...
(\url{https://github.com/davidsandberg/facenet}). This detector provided
information about the presence of a face as well as its size and
position.
...
trailing behind in the high density sample. Due to the high performance
of these two detectors we've included the results of both in the
analyses to follow.
