...
```{r detByNaming, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=3, fig.height=3, fig.cap = "Proportion face detections around a naming window as a function of infants's posture"  }
ggplot(aroundNamings, aes(x = factor(posture), y = face, color=posture)) + 
  geom_boxplot() + 
  ylab("Prop. face detections in naming window") + 
  xlab("Posture") + 
  theme_bw() 
```
