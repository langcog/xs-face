...
## read in ground truth detectors
...
#  tab2 <- xtable::xtable(performance, digits=3, caption = "Detector performance", type="latex", comment = F, table.placement = "H")
# ```
...
\begin{tabular}{rllrrr}
  \hline
 & detectorType & sample\_type & p & r & f \\ 
  \hline
1 & MTCNN & high\_density & 0.841 & 1.000 & 0.914 \\ 
  2 & MTCNN & random & 0.947 & 0.750 & 0.837 \\ 
  3 & OpenPose & high\_density & 0.995 & 0.863 & 0.924 \\ 
  4 & OpenPose & random & 0.710 & 0.917 & 0.800 \\ 
  5 & ViolaJones & high\_density & 0.991 & 0.495 & 0.660 \\ 
