...
### Needs to be consolidated so that we're aren't rereading all of these files here...
# data_vj<- read_csv("../data/final_output/viola.csv") %>%
...
```{r xtable, results="asis"}
 tab2 <- xtable::xtable(performance, digits=3, caption = "Detector performance")
```
