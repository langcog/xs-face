...
data_viola <- read_csv("../data/final_output/viola.csv") %>%
  distinct(video, frame, .keep_all = TRUE)
...
# render_table(viola_results, "Viola")
...
\begin{tabular}{rrrr}
  ...
  & P & R & F \\ 
\hline
ViolaJones High Density Sample & 0.99 & 0.50 & 0.66 \\
ViolaJones Random Sample & 0.39 & 0.29 & 0.33 \\
