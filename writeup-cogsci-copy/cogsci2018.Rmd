...
\begin{table}[t]
  ...
  \begin{center}
    \begin{tabular}{l|ccc|ccc}
      ...
      \hline
      % MTCNN & .84  & 1 &  .91 & .95 & .75 & .85   \\
      % OpenPose & .99 & .87 & .93 & .71 & .92 & .8 \\
    \hline
    \end{tabular}
  \end{center}
\end{table}
...
```{r detByAge, fig.env="figure*", fig.pos = "h", fig.align = "center", fig.width=7, fig.height=2, fig.cap = "Proportion face (left) and hand (right) detections as a function of participant's age. Note that the axes are different; hands were detected overall much less frequently in this dataset." }
