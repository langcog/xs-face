...
```{r fig.env="figure*", fig.pos = "h", fig.align = "center", fig.width=7, fig.height=3, fig.cap = "Proportion time that infants in each age group spent in each posture (left panel) and orientation relative to their caregiver (right  panel)." }
...
```{r faceByPostureFig, fig.env="figure*", fig.pos = "h", fig.align = "center", num.cols.cap=2, fig.width=7, fig.height=3, fig.cap = "Proportion of face detections as a function of infant's posture, using the MTCNN3 face detections and OpenPose face detections (left two panels) and the proportion of hand detections as a function of infant's posture, using OpenPose hand detections and the OpenPose wrist detections. "}
...
```{r faceByOrientFig, fig.env="figure*", fig.pos = "h", fig.align = "center", fig.width=7, fig.height=3, num.cols.cap=2, fig.cap = "Proportion of face detections as a function of caregiver's orientation,using the MTCNN3 detections (left panel) and OpenPose detections (right panel)" }
detectionsByPosture <- dlong %>%
  filter(!is.na(orientation)) %>%
