...
with their caregivers (Franchak et al., 2017), replicating and extending
their findings. Together, these results establish the validity of a new
method for detecting social information, confirm that motoric
developments play a significant role in shaping the social information
that infants have access to. We propose that the combined use of
head-mounted cameras and the application of new computer vision
techniques is a promising avenue for re-utilizing rich video datasets
collected across different labs and diverse contexts and understanding
the statistics of infants' visual and linguistic experience as they
