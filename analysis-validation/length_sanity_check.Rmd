...
MTCNN <- read_csv("../data/final_output/mtcnn3.csv")
openPose <- read_csv("../data/final_output/openpose_results_truncated_2.csv")
...
Mike's notes (Explanations of old discrepancies :)
